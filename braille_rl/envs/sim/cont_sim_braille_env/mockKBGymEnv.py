...
import copy
import gym
import braille_rl.envs.sim.cont_sim_braille_env.mock_kb as mkb
...
class mockKBGymEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.action_space = gym.spaces.Box(low=self.MKB.min_action, high=self.MKB.max_action, shape=(self.MKB.get_action_dimension(),), dtype=np.float32)
    ...
    def set_env_state(self, env_state):
        ...
        self.MKB.reset_pos(ee_pos=env_state[5])
    ...
    def _reward(self):
        ...
        if self.latest_button != 'NONE':
            ...
            # incorrect button pressed
                ...
                # print('Incorrect Button Press: ',self.latest_button )
                reward = self.min_rew
                self.terminated = 1
        else:
