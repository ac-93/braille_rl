...
import braille_rl.envs.robot.disc_ur5_braille_env.ur5_with_tactip as ur5
...
class UR5GymEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.action_list = self._UR5.action_list
    ...
    def set_env_state(self, env_state):
        ...
        self._UR5.reset_pos(ee_pos=env_state[5], x_idx=env_state[6], y_idx=env_state[7])
