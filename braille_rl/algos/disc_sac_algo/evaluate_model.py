    ...
    def test_agent(sequence):
        ...
        for j in range(n):
            ...
            while not(test_d or (test_ep_len == max_ep_len)):
                ...
                test_a = get_action(test_state, test_one_hot_goal, test_prev_a, deterministic_actions)
...
if __name__ == '__main__':
    run_evaluation(model_dir='../saved_models/sim/discrete/alphabet/disc_sac/disc_sac_s2/', model_save_name='tf1_save', seed=1)
